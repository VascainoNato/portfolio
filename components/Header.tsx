...
export default function Header() {
    ...
    return (
      <header className="flex h-20 items-center pl-8 pr-8 bg-gray-100 justify-between md:pl-10 md:pr-10 lg:pl-12 lg:pr-12 xl:pl-16 xl:pr-16 xl:h-22 2xl:pl-20 2xl:pr-20 2xl:h-24">
        <div className="flex items-center gap-2">
          <>
          <Image 
            src={Logo}
            alt="Logo"
            className="h-12 w-12 xl:w-14 xl:h-14 transition ease-in-out duration-800 hover:scale-[1.05]"
          />
           <h1 className="hidden md:flex md:text-sm md:text-neutral-800 xl:text-base md:transition md:ease-in-out md:duration-800 md:hover:scale-[1.05]">Rafael Satyro - Frontend Engineer</h1>
          </>
        </div>
